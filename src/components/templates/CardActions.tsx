...
const styles = {
  dark: {
    ...
    walletBtn: "py-3 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl flex items-center justify-center gap-2 transition-colors active:scale-[0.98]",
  ...
  light: {
    ...
    walletBtn: "py-3 border border-neutral-200 hover:border-neutral-300 rounded-xl flex items-center justify-center gap-2 text-neutral-600 transition-colors active:scale-[0.98]",
  ...
  glass: {
    ...
    walletBtn: "py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl flex items-center justify-center gap-2 transition-colors active:scale-[0.98]",
  ...
  amber: {
    ...
    walletBtn: "py-3 bg-amber-900/30 hover:bg-amber-900/50 border border-amber-500/20 rounded-xl flex items-center justify-center gap-2 transition-colors active:scale-[0.98]",
  ...
  rose: {
    ...
    walletBtn: "py-3 bg-stone-800 hover:bg-stone-700 rounded-xl flex items-center justify-center gap-2 transition-colors active:scale-[0.98]",
  ...
  tech: {
    ...
    walletBtn: "py-3 bg-gray-900 hover:bg-gray-800 border border-gray-800 rounded flex items-center justify-center gap-2 transition-colors active:scale-[0.98]",
