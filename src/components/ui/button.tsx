...
const buttonVariants = cva(
  // Base styles - VERROUILLÉ pour mobile-first UX premium
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body touch-manipulation select-none active:scale-[0.97] active:brightness-95",
  {
    variants: {
      variant: {
