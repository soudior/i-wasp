      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {[...Array(20)].map((_, i) => (
          <motion.div
            ...
            animate={{
              x: [
                Math.cos((i * Math.PI * 2) / 20) * (100 + i * 8),
                Math.cos((i * Math.PI * 2) / 20 + Math.PI) * (100 + i * 8),
                Math.cos((i * Math.PI * 2) / 20) * (100 + i * 8),
              ],
              y: [
                Math.sin((i * Math.PI * 2) / 20) * (100 + i * 8),
                Math.sin((i * Math.PI * 2) / 20 + Math.PI) * (100 + i * 8),
                Math.sin((i * Math.PI * 2) / 20) * (100 + i * 8),
              ],
              opacity: [0.2, 0.8, 0.2],
              scale: [0.5, 1.5, 0.5],
      ...
      <div className="relative w-48 h-48 mb-10" style={{ perspective: "1000px" }}>
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: `0 0 40px ${STUDIO.or}20`,
          }}
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: `
              0 0 60px ${STUDIO.or}30,
              inset 0 0 40px ${STUDIO.or}10,
              0 20px 40px ${STUDIO.noir}
            `,
          }}
          animate={{
            boxShadow: [
        ...
        >
          <motion.div
            ...
            style={{
              ...
              boxShadow: `0 0 20px ${STUDIO.or}60`,
            }}
            initial={{ width: "0%" }}
            ...
            <motion.div
              ...
              animate={{
                ...
                boxShadow: idx === currentStep 
                  ? [`0 0 0px ${STUDIO.or}`, `0 0 20px ${STUDIO.or}60`, `0 0 0px ${STUDIO.or}`]
                  : `0 0 0px ${STUDIO.or}`,
              }}
              transition={{ duration: 1, repeat: idx === currentStep ? Infinity : 0 }}
            >
              {idx < currentStep ? (
                <motion.div
                  initial={{ scale: 0 }}
