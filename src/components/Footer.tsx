...
// WhatsApp contact - Numéro officiel i-wasp
const WHATSAPP_NUMBER = "33626424394";
const WHATSAPP_MESSAGE = "Bonjour 👋\nJe souhaite des informations sur i-wasp.";
    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        ...
        <a
          ...
          className="flex items-center gap-3 bg-[#25D366] hover:bg-[#1fb855] text-white px-5 py-3 rounded-full shadow-lg shadow-[#25D366]/30 transition-all duration-300 hover:scale-105 hover:shadow-xl"
