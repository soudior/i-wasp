          ...
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center gap-3 mb-4">
              <div className="w-8 h-8 rounded-lg bg-background flex items-center justify-center">
                <span className="text-foreground font-bold text-sm">iW</span>
              </div>
              <span className="text-background font-semibold text-lg tracking-tight">iWasp</span>
            </Link>
            <p className="text-background/70 text-sm leading-relaxed max-w-xs font-light">
              L'élégance du networking digital.
            </p>
          </div>
