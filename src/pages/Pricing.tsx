...
const WEB_PLANS = [
  {
    ...
    features: ["Design responsive", "Formulaire contact", "Hébergement inclus", "SEO de base"],
    icon: Globe,
    popular: false,
  },
  {
    ...
    features: ["Tout Basic +", "Galerie avancée", "Réservation/paiement", "SEO optimisé", "Blog intégré"],
    icon: Star,
    popular: true,
  },
  {
    ...
    priceMAD: 10000,
    priceEUR: 1000,
    description: "CRM complet sur-mesure",
    features: ["Tout Pro +", "CRM intégré", "Analytics avancé", "Support 1 an"],
    icon: Crown,
    popular: false,
  },
];
