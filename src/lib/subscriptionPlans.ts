...
export const SUBSCRIPTION_PLANS = {
  ...
  SIGNATURE: {
    ...
    businessFeatures: [
      "🎯 Capturez chaque visiteur",
      "📲 Recontactez vos leads par push",
      "Dashboard de suivi",
      "Badge Signature",
      "Conseiller IA dédié",
      "Intégration CRM",
...
export const FEATURE_COMPARISON = [
  ...
  { name: "🔥 Capture de leads", free: false, gold: true, category: "business", highlight: true },
  { name: "🔔 Push Notifications", free: false, gold: true, category: "business", highlight: true },
