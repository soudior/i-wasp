...
const NFC_TIERS: Record<string, { name: string; amountMadCents: number; quantity: number }> = {
  essentielle:    { name: "Carte NFC Essentielle + 3 mois Pro",    amountMadCents: 32900,  quantity: 1 },
  professionnelle:{ name: "Carte NFC Professionnelle + 3 mois Pro", amountMadCents: 54900,  quantity: 1 },
  prestige:       { name: "Carte NFC Prestige + 3 mois Pro",        amountMadCents: 98900,  quantity: 1 },
  pack_team:      { name: "Pack TEAM (5 cartes) + 3 mois Pro",      amountMadCents: 218900, quantity: 5 },
};
